...
def run_tool_server():
    ...
    def load_spotify_tools():
        SPOTIFY_CLIENT_ID = os.environ.get('SPOTIPY_CLIENT_ID',None)
        SPOTIFY_CLIENT_SECRET = os.environ.get('SPOTIPY_CLIENT_SECRET',None)
        SPOTIFY_REDIRECT_URI = os.environ.get('SPOTIPY_REDIRECT_URI',None)
        server.load_tool("spotify",{"client_id": SPOTIFY_CLIENT_ID,"client_secret":SPOTIFY_CLIENT_SECRET,"redirect_uri":SPOTIFY_REDIRECT_URI})
